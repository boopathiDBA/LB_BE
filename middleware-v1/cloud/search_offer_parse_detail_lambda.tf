module "search_offer_parse_detail" {
  source  = "terraform-aws-modules/lambda/aws"
  version = "4.7.1"

  function_name = "${var.environment}-be-search-offer-parse-detail-service"
  description   = "Search offer on-demand scraping service"
  handler       = "app.delivery.rest.offer.parse_detail.handler"
  runtime       = "python3.9"
  publish       = true
  timeout       = 60
  memory_size   = 512
  hash_extra    = "middleware-search-offer-parse-detail"
