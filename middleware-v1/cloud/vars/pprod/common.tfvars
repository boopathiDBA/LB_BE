...
vpc_base_cidr_block       = "172.16.211.0/24"
domain_name               = "web.littlebirdie.com.au"
cache_domain_name         = "pc.web.littlebirdie.com.au"
subject_alternative_names = ["ps.web.littlebirdie.com.au"]
...
merge_external_vars = {
  ...
  "LB_WEB_BASE_URL" = "https://ps.web.littlebirdie.com.au",
  "ALADDIN_API_TIMEOUT" = "2",
  "DEPLOY_ENV"  = "pprod",
  "RUN_ENV"  = "pprod",
  "POWERTOOLS_SERVICE_NAME"  = "pprod-search-api",
  "SEARCH_SERVICE_SECRET_NAME" = "/pprod/search-services-a",
